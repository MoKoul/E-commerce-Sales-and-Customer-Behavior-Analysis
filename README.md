...
- **Customer Lifetime Value (CLV) Estimation**: Calculating forward-looking CLV for different customer segments using 2011 spending behaviour combined with actual observed 2010→2011 retention rate.
...
- **visualizations/**: Contains output images generated by the Jupyter notebook.
