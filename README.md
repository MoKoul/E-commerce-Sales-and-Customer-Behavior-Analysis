...
- **RFM Analysis**: Segmenting customers into categories like Champion, Loyal, Potential Loyalist, New, At-Risk, and Hibernating/Dormant based on Recency, Frequency, and Monetary metrics.
...
We utilized an RFM analysis (Recency, Frequency, Monetary value) to identify seven distinct customer segments. The table below outlines the behavioral profile of each group based on their average spending habits, visit frequency, and days since their last visit (Avg. Recency):
...
*   Champions exhibit significantly higher engagement (3x more frequent buys) and monetary value (4x higher spend) compared to the next tier, **'Loyal Customers'**.
...
Over the two-year period **72%** of customer base consists of repeat buyers. This group of  customers, accounting for **96.8%** of total sales.

### 5. What percentage of customers return within the first 90 days

46% of new customers return within the first 90 days. This group of repeat buyers is highly valuable, generating 80% of total sales (£14M). While the average first-purchase value is £415, the average value of the second purchase for this specific group is £367.
...
- **visualizations/**: Contains output image files generated by the Jupyter notebook
